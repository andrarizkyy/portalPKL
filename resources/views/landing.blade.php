    ...
    <section id="fitur" class="py-28 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                @foreach([
                ['🎓', 'Untuk Siswa', 'Temukan lowongan PKL yang sesuai bidang studi, lamar dengan mudah, dan pantau
                status lamaran secara real-time.', 'from-blue-500 to-cyan-500', 'blue'],
                ['🏢', 'Untuk DUDI', 'Buat lowongan, kelola posisi, dan pilih kandidat terbaik dari database siswa yang
                terverifikasi.', 'from-purple-500 to-pink-500', 'purple'],
                ['🛡️', 'Admin Verified', 'Setiap perusahaan melewati proses verifikasi ketat oleh admin untuk keamanan
